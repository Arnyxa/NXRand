...
int main() 
{
	...
	nx::dRand mydRand;                    // random object that stores doubles, in the range 0.0 to 1.0 (default)
	nx::iRand myiRand(12, 54);            // random object that stores ints, range 12~54 (the default for integrals is 1~100)
